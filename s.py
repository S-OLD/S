...
def old_One():
    ...
    with tred(max_workers=10) as pool:
        print((f"\x1b[1;96m[★]➤ TOTAL IDS CRACK : \x1b[1;32m{limit:<10}\x1b[0m") .ljust(75) + "\x1b[38;5;51m│\x1b[0m")
        print((f"\x1b[1;96m[★]➤ SELECTED        : \x1b[1;32mM1\x1b[0m") .ljust(75) + "\x1b[38;5;51m│\x1b[0m")
        print((f"\x1b[1;96m[★]➤ USE VPN         : \x1b[1;32m1.1.1.1\x1b[0m / \x1b[1;31mPROTON\x1b[0m").ljust(79) + "\x1b[38;5;51m│\x1b[0m")
        print("\x1b[38;5;46m──────────────────────────────────────────────────────────┘\x1b[0m")
        for mal in user:
            uid = star + mal
            if meth == '1':
