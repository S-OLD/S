...
def BNG_71_():
    ...
    while True:
        ...
        print('\x1b[38;5;45m│ \x1b[1;92m<1>\x1b[1;97m OLD CLONE'.ljust(55) + '\x1b[38;5;45m│')
        print('\x1b[38;5;45m└──────────────────────────────────────────────┘\x1b[0m')

        __Jihad__ = input(
            f"\n\x1b[1;91m➤\x1b[1;97m CHOICE {W}:{Y} "
            f"\x1b[1;92m➤➤\x1b[0m "
        )
...
def access_denied_block(key, status, exp=None):
    ...
    print(C + "│" + W + " COPY THIS KEY AND SEND TO ADMIN ".center(48) + C + "│")

    print(C + "├───────────────────────────────────────────────┤" + X)

    print(C + "│ " + Y + f"{key}".center(45) + C + "│")
    ...
    print(G + "│ " + W + "ACCOUNT NAME : " + Y + "MUHAMMAD SAFDAR".ljust(27) + G + "│")

    print(G + "├───────────────────────────────────────────────┤" + X)

    print(G + "│ " + W + "EASYPAISA : " + C + "03060725589".ljust(32) + G + "│")

    print(G + "│ " + W + "JAZZCASH  : " + C + "03060725589".ljust(32) + G + "│")

    print(G + "│ " + W + "SADAPAY   : " + C + "03060725589".ljust(32) + G + "│")

    print(G + "├───────────────────────────────────────────────┤" + X)

    print(G + "│ " + W + "3 DAYS   : " + Y + "150 PKR".ljust(32) + G + "│")

    print(G + "│ " + W + "7 DAYS   : " + Y + "300 PKR".ljust(32) + G + "│")

    print(G + "│ " + W + "30 DAYS  : " + Y + "500 PKR".ljust(32) + G + "│")
